...
class _PepsiState extends State<Pepsi> with TickerProviderStateMixin {
  late AnimationController cupController;
  late AnimationController coverController;
  late AnimationController coverTopController;
  late AnimationController strawController;
  late AnimationController shadowController;
  late AnimationController fadeController;
  late AnimationController filledController;

  late Animation<double> cupAnimation;
  late Animation<double> coverAnimation;
  late Animation<double> coverTopAnimation;
  late Animation<double> strawAnimation;
...
class CupPainter extends CustomPainter {
  ...
  CupPainter({
    required this.cupProgress,
    required this.coverProgress,
    required this.coverTopProgress,
    required this.strawProgress,
